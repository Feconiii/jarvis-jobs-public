...
import { guardArgs } from './jarvis/cli.mjs';

const USAGE = `
  npm run liveness -- [options]

  Is this posting still live? Hits the ATS API first, browser only if needed.
...
guardArgs({ usage: USAGE, flags: ["--file","--no-fallback","--throttle"], valued: ["--file","--throttle"] });
